 ...
 * <p>
 * This class applies Boundary Value Analysis (BVA) and Edge Case Testing to verify 
 * the correctness of {@code intersects()} based on the Javadoc specifications.
 * </p>
 * 
 * <b>Test Cases:</b>
...
class IntersectsTests {
    ...
    /**
     * Tests {@code intersects()} with an exact overlapping range.
    ...
    /**
     * Tests {@code intersects()} with a partially overlapping range (lower bound).
     * Expected Result: {@code true}.
     */
    @Test
    ...
    /**
     * Tests {@code intersects()} with a partially overlapping range (upper bound).
     * Expected Result: {@code true}.
     */
    @Test
    ...
    /**
     * Tests {@code intersects()} with a completely non-overlapping range.
    ...
    /**
     * Tests {@code intersects()} when the range just touches the lower boundary.
     * Expected Result: {@code true}.
     */
    @Test
    void testIntersects_TouchesLowerBoundary() {
        assertTrue(testRange.intersects(-10, -5));
    }

    /**
     * Tests {@code intersects()} when the range just touches the upper boundary.
     * Expected Result: {@code true}.
     */
    @Test
    ...
    /**
     * Tests {@code intersects()} with an extremely large range covering the entire space.
     * Expected Result: {@code true}.
     */
    @Test
    ...
    /**
     * Tests {@code intersects()} when the range is a single point inside the test range.
     * Expected Result: {@code true}.
     */
    @Test
    ...
    /**
     * Tests {@code intersects()} when the range is a single point outside the test range.
     * Expected Result: {@code false}.
     */
    @Test
